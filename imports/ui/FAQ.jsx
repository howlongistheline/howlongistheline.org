...
export default function faq({}) {
    return (
      ...
      <Card>
        ...
        <p>You can add any store to this site, no matter where it is. If your local stores are not listed, simply add them and ask your local community to update the numbers when they visit the store.</p>
      </Card>

      <Card>
        <div className="title">I've got an idea to make this better, what should I do?</div>
        <p>
          If you're a developer, send a pull request to <a href="https://github.com/howlongistheline/howlongistheline.org">the Github repository</a>.
          If you're not a developer, you can still browse through <a href="https://github.com/howlongistheline/howlongistheline.org/issues">the list of issues</a> we are working on and features we are adding.
          You may also want to look at the <a href="https://www.facebook.com/groups/1161156860891990/">Facebook group</a>.
        </p>
      </Card>
