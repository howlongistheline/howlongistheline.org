    ...
    return (
        <MainLayout>
            ...
            <Checkbox
                ...
                checked={confirm}
                modifier='material' />
            Are you at this location right now? If not, the listing will probably be removed. Please use the feedback form to contact us if you want a store added but can't physically go there, thank you :)
            </ListItem>
